...
constructor() {
  ...
  this.timeout = 25000; // Kurangi timeout untuk Vercel
}
  ...
  async scrapeWithBrowser() {
    ...
    try {
      ...
      // Konfigurasi untuk Vercel
        ...
        // Gunakan Chrome yang tersedia di Vercel
      ...
      // Tunggu beberapa detik untuk memastikan React selesai render
      ...
      return {
        ...
        data: sensorData,
        debug: {
          all_elements: pageData.elementsWithData.slice(0, 20), // First 20 elements
  ...
  extractRainfall(text) {
    ...
    return match ? `${match[1]} mm` : '0 mm'; // Default 0 mm jika tidak ada hujan
  }
  ...
  extractOxygen(text) {
    ...
    return match ? `${match[1]} %VOL` : '21 %VOL'; // Default udara normal
  }
